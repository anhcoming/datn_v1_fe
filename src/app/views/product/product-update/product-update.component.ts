...
export class ProductUpdateComponent implements OnInit {
  ...
  constructor(private http: HttpClient, private uploadService: UploadService, private toastr: NotiService, public router: Router, private activeRoute: ActivatedRoute, private fb: FormBuilder,
    ...
    //   if (this.color[i].id == this.arr[i].id) {
    //     this.colorDefault = this.color[i].name
    //   }
    // }
  }
  ...
  getDetailItem(item: any) {
    ...
    this.product.getDetailItem(item.id).subscribe((res: any) => {
      this.listItem = this.fullData.optionss;
  ...
  getCateName(id: any) {
    ...
    //   }
    // }
    this.cate.detail(id).subscribe((res: any) => {
      this.categoryDefault = res.name;
  ...
  async updateE() {
    ...
    this.fullData.options[this.index].image = this.image == "" ? this.fullData.options[this.index].image : this.image
    this.imageE = this.fullData.options[this.index].image
    this.arr = this.fullData.options
